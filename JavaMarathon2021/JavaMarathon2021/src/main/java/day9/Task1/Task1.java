...
дополнительное строковое поле - название его учебной группы (англ. groupName). Для этого поля тоже
необходимо создать геттер. Конструктор в классе Студент должен принимать на вход два аргумента - имя
и название учебной группы. Метод printInfo() в классе Студент должен быть переопределен таким образом,
...
преподаватель. Для этого поля необходимо создать get метод. Конструктор в классе Преподаватель
...
public class Task1 {
    public static void main(String[] args) {
        Student student1 = new Student("Vasya", "Group 101");
        Teacher teacher1 = new Teacher("Ivan Petrovich", "Algebra");
        student1.printInfo();
        System.out.println("Group num: " + student1.getGroupName());
        teacher1.printInfo();
        System.out.println("Subgect: " + teacher1.getSubjectName());
